...
const { createProxyMiddleware } = require('http-proxy-middleware'); // Correção aqui
...
// Configuração das rotas proxy - Correção aqui também
app.use('/gestao', createProxyMiddleware(createProxyOptions(services.gestao)));
app.use('/faturamento', createProxyMiddleware(createProxyOptions(services.faturamento)));
app.use('/planosativos', createProxyMiddleware(createProxyOptions(services.planosativos)));
